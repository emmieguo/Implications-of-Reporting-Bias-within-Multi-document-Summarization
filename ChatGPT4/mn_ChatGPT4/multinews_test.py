...
# load all files
gen_summaries = '/kaggle/input/chatgpt4/out_mn_ChatGPT4.txt'
human_summaries = '/kaggle/input/chatgpt4/human_mn_ChatGPT4.txt'
original_documents = '/kaggle/input/multinewsfirst10/10_mn.json'
